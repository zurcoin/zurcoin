...
*Setup instructions for a Gitian build of Zurcoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Zurcoin
...
- [Building Zurcoin Core](#building-zurcoin-core)
...
To build Zurcoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
