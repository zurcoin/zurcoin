...
The RPM spec file provided here is for Zurcoin-Core 0.12.0 and builds on CentOS
...
[Zurcoin git repository](https://github.com/zurcoin/zurcoin) but are not part of
...
in the zurcoin git repository. At present only an SVG version of the Zurcoin
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the Zurcoin git
master branch.
...
idea to build Zurcoin Core against a static version of that library compiled
...
Zurcoin-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging Zurcoin for Fedora at least since 2012.
