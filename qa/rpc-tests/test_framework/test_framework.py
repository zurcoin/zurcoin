...
# Test framework for doing p2p comparison testing, which sets up some zurcoind
# binaries:
...
class ComparisonTestFramework(BitcoinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("BITCOIND", "zurcoind"),
                          help="zurcoind binary to test")
        parser.add_option("--refbinary", dest="refbinary",
                          default=os.getenv("BITCOIND", "zurcoind"),
                          help="zurcoind binary to use for reference nodes (if any)")
